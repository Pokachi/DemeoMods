...
namespace DemeoMods.DifficultyMod.UI
{
    class DifficultyMenu : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            CreateText(enemyHPMultiplier.transform, new Vector3(0.036f, 0.15f, 1.4f), 4.5f, new Color(0.0392f, 0.0157f, 0, 1), "Enemy HP", TextAlignmentOptions.Center, FontStyles.Normal);
            ...
            CreateButton(enemyHPMultiplier.transform, new Vector3(-1.2f, 0.15f, 0.4f), "Enemy HP Multiplier Down", "DreadArrowDown", () => { DifficultySettings.DecreaseEnemyHPMultiplier(text => { UpdateText(enemyHPMultiplierValue, text); }); });
            CreateButton(enemyHPMultiplier.transform, new Vector3(1.3f, 0.15f, 0.4f), "Enemy HP Multiplier Up", "DreadArrowUp", () => { DifficultySettings.IncreaseEnemyHPMultiplier(text => { UpdateText(enemyHPMultiplierValue, text); }); });
            ...
            CreateText(enemyAttackMultiplier.transform, new Vector3(0.036f, 0.15f, -.6f), 4.5f, new Color(0.0392f, 0.0157f, 0, 1), "Enemy Attack", TextAlignmentOptions.Center, FontStyles.Normal);
            ...
            CreateText(energyGainMultiplier.transform, new Vector3(0.036f, 0.15f, -2.6f), 4.5f, new Color(0.0392f, 0.0157f, 0, 1), "Energy Gain", TextAlignmentOptions.Center, FontStyles.Normal);
            ...
            CreateText(goldPileMultiplier.transform, new Vector3(0.036f, 0.15f, 1.4f), 4.5f, new Color(0.0392f, 0.0157f, 0, 1), "Gold Pile Amount", TextAlignmentOptions.Center, FontStyles.Normal);
            ...
            CreateText(cardSaleMultiplier.transform, new Vector3(0.036f, 0.15f, -0.6f), 4.5f, new Color(0.0392f, 0.0157f, 0, 1), "Card Selling Price", TextAlignmentOptions.Center, FontStyles.Normal);
